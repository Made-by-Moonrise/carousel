function initializeTouchCarousel() {
    ...
    jQuery(function ($) {
        ...
        //==============================================================================
        // TOUCH CAROUSEL TILE SIZE CSS CONFIGURATION START
        //==============================================================================
        ...
        //==============================================================================
        // TOUCH CAROUSEL TILE SIZE CSS CONFIGURATION END
        //==============================================================================


        //==============================================================================
        // TOUCH CAROUSEL CONFIGURATION START
        //==============================================================================
        ...
        if (isTouch == true) {
            ...
            if (snap == 'false') {
                $("#about-carousel, #casestudy-carousel, #news-carousel, #newsmobile-carousel, #newsdetail-carousel, #press-carousel, #contact-carousel, #sitemap-carousel").touchCarousel({
